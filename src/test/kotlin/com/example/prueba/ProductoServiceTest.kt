...
class ProductServiceTest {
    ...
    @Test
    fun ultimoDigito(){
        val response=productService.ultimoDigito("0107471047")
        Assertions.assertEquals(8,response)
    }
    @Test
    fun CedulaValida(){
        val response=productService.validarTotal("0107471047")
        Assertions.assertEquals(true,response)
    }
    @Test
    fun CedulaNoValida(){
        val response=productService.validarTotal("0107491047")
